                                ...
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        <div className="btn-group btn-group-sm" role="group" >
                                            <button type="button" className="btn btn-warning btn-sm" onClick={(e) => { this.GetManagerById(item._id) }}>Edit</button>
                                            <button onClick={(e) => { this.deleteManager(item._id) }} className="btn btn-danger btn-sm">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
